...
Una aplicación web inteligente desarrollada por **Geronimo Facundo Moreira** que utiliza la API de Google AI Studio para crear quizzes personalizados basados en tu contenido de estudio.
...
- 🎯 **Misión**: Promover la robótica, electrónica y crear herramientas educativas innovadoras que potencien el aprendizaje
...
- **🎯 Tipos de Quiz**: Opción múltiple o respuesta abierta inteligente
- **🤖 Evaluación con IA**: Calificación automática con justificaciones detalladas
- **🎨 Interfaz Moderna**: Diseño responsive y atractivo
- **🎵 Música Integrada**: Buscador de YouTube incorporado para ambiente de estudio
...
- **🔍 Buscador YouTube**: Navegación directa sin salir de la app
- **🎶 Categorías Predefinidas**: Lo-Fi, Clásica, Jazz, Ambient, Piano, Naturaleza
- **🎯 Sugerencias Inteligentes**: Música optimizada para estudiar
- **🎛️ Controles Integrados**: Reproducir, pausar, detener sin interrupciones
...
- Selecciona tipo: Opción múltiple o respuesta abierta
- Número de preguntas: 5-20
- Nivel de dificultad: Fácil, Intermedio, Difícil
- Generación inteligente basada en contenido

#### 4. 🎵 Ambiente Musical (Opcional)
- Haz clic en el botón "Música"
- **🔍 Buscar**: Encuentra música por categoría
- **🎯 Sugerencias**: Selecciona del catálogo curado
- **🔗 URL Directa**: Pega enlaces de YouTube
- Reproduce sin interrumpir tu estudio

#### 5. 📝 Realizar el Quiz
- Timer automático para seguimiento
...
- **Multimedia**: Integración con YouTube
...
- 🎵 **YouTube** por la integración musical
...
*Hecho con pasión para revolucionar la educación con inteligencia artificial* 🚀
